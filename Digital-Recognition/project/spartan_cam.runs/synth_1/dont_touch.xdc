...
# IP: bd/system/ip/system_rgb_test_0_1/system_rgb_test_0_1.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_rgb_test_0_1 || ORIG_REF_NAME==system_rgb_test_0_1} -quiet] -quiet

# IP: bd/system/ip/system_digital_recognition_0_0/system_digital_recognition_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_digital_recognition_0_0 || ORIG_REF_NAME==system_digital_recognition_0_0} -quiet] -quiet

# IP: bd/system/ip/system_lcd_num_0_0/system_lcd_num_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_lcd_num_0_0 || ORIG_REF_NAME==system_lcd_num_0_0} -quiet] -quiet
